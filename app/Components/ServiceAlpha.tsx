...
export default async function ServiceAlpha({ uniqueService }: Params) {
  ...
  return (
    <section className='w-[95%] flex items-center pt-20 pb-8 justify-center gap-4'>
        <div className='flex items-center w-full flex-wrap border-b pb-10 border-black relative justify-center' >
            <p className="min-[758px]:text-[70px] text-center leading-[40px] text-[30px] whitespace-pre-wrap min-[758px]:leading-[80px]">{serviceDetailData.title}</p>                             
